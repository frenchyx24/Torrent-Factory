...
# ⚡ Torrent Factory V1.0
### *L'automatisation ultime pour votre bibliothèque média*

[![Version](https://img.shields.io/badge/version-1.0.0-indigo?style=for-the-badge)](https://github.com/${GITHUB_REPOSITORY})
...
- ⚙️ **Moteur V1.0** : Gestion des tâches en arrière-plan avec file d'attente et workers multiples.
