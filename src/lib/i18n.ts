export const translations = {
  fr: {
    ...
    movies: { title: "Bibliothèque Films", subtitle: "Gerez vos films et générez des torrents.", scan: "Scanner", generate: "Tout Générer", search: "Rechercher un film...", table: { name: "NOM DU FILM", lang: "LANGUE", size: "TAILLE", action: "ACTION" } },
    ...
    settings: { title: "Configuration V1.0 Stable", subtitle: "Moteur de création Stable ultra-robuste.", save: "ENREGISTRER LA CONFIGURATION", sections: { dirs: "Répertoires", torrent: "Paramètres Torrent", system: "Options & Performance", language: "Langue de l'interface" }, fields: { tracker: "Tracker URL", piece: "Taille Pièces (0=auto)", timeout: "Timeout (sec)", exclude: "Fichiers à exclure", comment: "Commentaire", workers: "Workers simultanés", lang: "Choisir la langue" }, options: { private: "Mode Privé", audio: "Générer NFO", size: "Afficher Taille", reset: "Reset Tâches" } }
  },
  en: {
    nav: { series: "Series", movies: "Movies", torrents: "Torrents", tasks: "Tasks", logs: "Logs", settings: "Settings" },
    index: { title: "Series Library", subtitle: "Smart generation by packs or seasons.", scan: "Scan", generate: "Generate All", search: "Search for a series...", table: { name: "SERIES NAME", lang: "LANGUAGE", mode: "MODE", action: "ACTION" }, modes: { complete: "Complete Pack", season: "By Episode", episode: "By Episode" } },
    ...
    settings: { title: "Configuration V1.0 Stable", subtitle: "Ultra-robust Stable real creation engine.", save: "SAVE CONFIGURATION", sections: { dirs: "Directories", torrent: "Torrent Settings", system: "Options & Performance", language: "Interface Language" }, fields: { tracker: "Tracker URL", piece: "Piece Size (0=auto)", timeout: "Timeout (sec)", exclude: "Files to exclude", comment: "Comment", workers: "Simultaneous Workers", lang: "Choose language" }, options: { private: "Private Mode", audio: "Generate NFO", size: "Show Size", reset: "Reset Tasks" } }
  },
  de: {
    ...
    settings: { title: "Konfiguration V1.0 Stable", subtitle: "Echte Stable Erstellungs-Engine avec mktorrent.", save: "KONFIGURATION SPEICHERN", sections: { dirs: "Verzeichnisse", torrent: "Torrent-Einstellungen", system: "Optionen & Leistung", language: "Oberflächensprache" }, fields: { tracker: "Tracker-URL", piece: "Stückgröße (0=auto)", timeout: "Timeout (Sek.)", exclude: "Auszuschließende Dateien", comment: "Kommentar", workers: "Max. Arbeiter", lang: "Sprache wählen" }, options: { private: "Privater Modus", audio: "Générer NFO", size: "Größe anzeigen", reset: "Aufgaben zurücksetzen" } }
  }
};
