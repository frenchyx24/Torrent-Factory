export const translations = {
  fr: {
    ...
    settings: { title: "Configuration V1.3.0", subtitle: "Moteur de création Titanium ultra-robuste.", save: "ENREGISTRER LA CONFIGURATION", sections: { dirs: "Répertoires", torrent: "Paramètres Torrent", system: "Options & Performance", language: "Langue de l'interface" }, fields: { tracker: "Tracker URL", piece: "Taille Pièces (0=auto)", timeout: "Timeout (sec)", exclude: "Fichiers à exclure", comment: "Commentaire", workers: "Workers Max", lang: "Choisir la langue" }, options: { private: "Mode Privé", audio: "Analyse Audio", size: "Afficher Taille", reset: "Reset Tâches" } }
  },
  en: {
