export const translations = {
  fr: {
    ...
    settings: { title: "Configuration V1.0.7", subtitle: "Moteur de création réel avec torrent-tool activé.", save: "ENREGISTRER LA CONFIGURATION", sections: { dirs: "Répertoires", torrent: "Paramètres Torrent", system: "Options & Performance", language: "Langue de l'interface" }, fields: { tracker: "Tracker URL", piece: "Taille Pièces (0=auto)", timeout: "Timeout (sec)", exclude: "Fichiers à exclure", comment: "Commentaire", workers: "Workers Max", lang: "Choisir la langue" }, options: { private: "Mode Privé", audio: "Analyse Audio", size: "Afficher Taille", reset: "Reset Tâches" } }
  },
  en: {
  ...
  de: {
    ...
    tasks: { title: "Aktuelle Aktivitäten", subtitle: "Globaler et dateibezogener Fortschritt.", clear: "Löschen", empty: "Derzeit laufen keine Aufgaben.", global: "Globaler Fortschritt", status: { running: "LÄUFT", completed: "ABGESCHLOSSEN", cancelled: "ABGEBROCHEN", pending: "AUSSTEHEND" } },
    ...
    settings: { title: "Konfiguration v1.0.7", subtitle: "Echte Erstellungs-Engine mit torrent-tool aktiviert.", save: "KONFIGURATION SPEICHERN", sections: { dirs: "Verzeichnisse", torrent: "Torrent-Einstellungen", system: "Optionen & Leistung", language: "Oberflächensprache" }, fields: { tracker: "Tracker-URL", piece: "Stückgröße (0=auto)", timeout: "Timeout (Sek.)", exclude: "Auszuschließende Dateien", comment: "Comment", workers: "Max. Arbeiter", lang: "Sprache wählen" }, options: { private: "Privater Modus", audio: "Audio-Analyse", size: "Größe anzeigen", reset: "Aufgaben zurücksetzen" } }
  }
};
